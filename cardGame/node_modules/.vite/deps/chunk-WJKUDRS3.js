...
function loopCreate() {
  ...
  for (let i = 0; i < appendSlides.length; i += 1) {
    $wrapperEl.append(dom_default(appendSlides[i].cloneNode(true)).addClass(params.slideDuplicateClass));
  }
  for (let i = prependSlides.length - 1; i >= 0; i -= 1) {
    $wrapperEl.prepend(dom_default(prependSlides[i].cloneNode(true)).addClass(params.slideDuplicateClass));
  }
}
...
//# sourceMappingURL=chunk-WJKUDRS3.js.map
